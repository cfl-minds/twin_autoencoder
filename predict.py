...
model = load_model(r'E:\Uncert_U_net\For_paper\Twin-AE\best_0.1_12_2.h5', custom_objects={'tf': tf}, compile=False)
#model.compile(loss=custom_loss(1), optimizer=optimizers.Adam(lr=learning_rate))
...
predicted_imgs, error, mse = predict_images(model, imgs, sols)
print(mse)
